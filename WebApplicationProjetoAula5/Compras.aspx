...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
    <asp:GridView runat="server" CssClass="table table-hover" ID="GVCompras" AutoGenerateColumns="False" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        <Columns>
